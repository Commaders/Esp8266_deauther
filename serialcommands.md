...
- **ssid** [-s] (optional, default = [settings ssid](https://github.com/Commaders/Esp8266_deauther/blob/master/settings.md#ssid)): Network name.  
- **password** [-pswd] (optional, default = [settings password](https://github.com/Commaders/Esp8266_deauther/blob/master/settings.md#password)): Password.  
